class cardDeck {
    ...
    renderCard(dealt_card) {
        ...
        cardElement += '<span class="suit ' + dealt_card.suit.toLowerCase() + '"></span>';
        cardElement += '</div>';
        cardElement += '<div class="card-footer-header text-center" ><small class="text-muted">' + dealt_card.name + '</small></div>';
        cardElement += '</div>';
